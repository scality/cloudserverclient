...
exports.CloudserverClient = exports.__Client = void 0;
...
class CloudserverClient extends smithy_client_1.Client {
    config;
    constructor(...[configuration]) {
        ...
        let _config_7 = (0, util_endpoints_1.resolveDefaultAwsRegionalEndpointsConfig)(_config_6);
        ...
        this.middlewareStack.use((0, core_1.getHttpAuthSchemeEndpointRuleSetPlugin)(this.config, {
            httpAuthSchemeParametersProvider: httpAuthSchemeProvider_1.defaultCloudserverHttpAuthSchemeParametersProvider, identityProviderConfigProvider: async (config) => new core_1.DefaultIdentityProviderConfig({
