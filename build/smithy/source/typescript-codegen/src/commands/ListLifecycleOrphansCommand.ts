 ...
 * @public
 */
export class ListLifecycleOrphansCommand extends $Command.classBuilder<ListLifecycleOrphansCommandInput, ListLifecycleOrphansCommandOutput, CloudserverClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
