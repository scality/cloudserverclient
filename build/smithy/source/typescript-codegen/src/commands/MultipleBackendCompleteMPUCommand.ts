 ...
 * @public
 */
export class MultipleBackendCompleteMPUCommand extends $Command.classBuilder<MultipleBackendCompleteMPUCommandInput, MultipleBackendCompleteMPUCommandOutput, CloudserverClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
