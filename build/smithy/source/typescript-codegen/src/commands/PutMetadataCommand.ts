 ...
 *
 */
export class PutMetadataCommand extends $Command.classBuilder<PutMetadataCommandInput, PutMetadataCommandOutput, CloudserverClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
