 ...
 * @public
 */
export class ListLifecycleNonCurrentsCommand extends $Command.classBuilder<ListLifecycleNonCurrentsCommandInput, ListLifecycleNonCurrentsCommandOutput, CloudserverClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
