 ...
 *
 */
export class GetBucketMetadataCommand extends $Command.classBuilder<GetBucketMetadataCommandInput, GetBucketMetadataCommandOutput, CloudserverClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
