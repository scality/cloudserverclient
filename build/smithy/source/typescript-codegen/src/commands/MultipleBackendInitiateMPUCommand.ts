 ...
 * @public
 */
export class MultipleBackendInitiateMPUCommand extends $Command.classBuilder<MultipleBackendInitiateMPUCommandInput, MultipleBackendInitiateMPUCommandOutput, CloudserverClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
