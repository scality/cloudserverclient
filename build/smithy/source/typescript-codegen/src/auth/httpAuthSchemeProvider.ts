 ...
 * @internal
 */
export const defaultCloudserverHttpAuthSchemeParametersProvider = async (config: CloudserverClientResolvedConfig, context: HandlerExecutionContext, input: object): Promise<CloudserverHttpAuthSchemeParameters> => {
  return {
...
function createAwsAuthSigv4HttpAuthOption(authParameters: CloudserverHttpAuthSchemeParameters): HttpAuthOption {
  return {
    ...
    propertiesExtractor: (config: Partial<CloudserverClientConfig>, context) => ({
      /**
       * @internal
       */
      signingProperties: {
 ...
 * @internal
 */
export const defaultCloudserverHttpAuthSchemeProvider: CloudserverHttpAuthSchemeProvider = (authParameters) => {
