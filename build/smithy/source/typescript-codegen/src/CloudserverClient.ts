...
import {
  ...
  defaultCloudserverHttpAuthSchemeParametersProvider,
 ...
 * @public
 */
export type CloudserverClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>>
  & ClientDefaults
  & UserAgentInputConfig
  & RetryInputConfig
  & RegionInputConfig
 ...
 * @public
 */
export type CloudserverClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions>
...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<CloudserverClientConfig>) {
    ...
    this.middlewareStack.use(getHttpAuthSchemeEndpointRuleSetPlugin(this.config
      , {
        httpAuthSchemeParametersProvider: defaultCloudserverHttpAuthSchemeParametersProvider,identityProviderConfigProvider: async (config: CloudserverClientResolvedConfig) => new DefaultIdentityProviderConfig({
